...
[MongoShield Documentation](../../../modules.md) / [provider-local/src](../README.md) / FileSystemProvider

# Class: FileSystemProvider

Defined in: [packages/provider-local/src/FileSystemProvider.ts:14](https://github.com/ShamalRathnayake/mongoshield/blob/37c34f4f1cc9c7701b1a943dbf51b10313c93a11/packages/provider-local/src/FileSystemProvider.ts#L14)
...
- [`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md)

## Constructors

### Constructor

> **new FileSystemProvider**(`options`, `compress?`): `FileSystemProvider`

Defined in: [packages/provider-local/src/FileSystemProvider.ts:21](https://github.com/ShamalRathnayake/mongoshield/blob/37c34f4f1cc9c7701b1a943dbf51b10313c93a11/packages/provider-local/src/FileSystemProvider.ts#L21)

#### Parameters

##### options

`string` \| [`FileSystemProviderOptions`](../interfaces/FileSystemProviderOptions.md)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`constructor`](../../../mongoshield/src/classes/AbstractStorageProvider.md#constructor)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`[captureRejectionSymbol]`](../../../mongoshield/src/classes/AbstractStorageProvider.md#capturerejectionsymbol)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`addListener`](../../../mongoshield/src/classes/AbstractStorageProvider.md#addlistener)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`createArchiveWriteStream`](../../../mongoshield/src/classes/AbstractStorageProvider.md#createarchivewritestream)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`createBsonWriteStream`](../../../mongoshield/src/classes/AbstractStorageProvider.md#createbsonwritestream)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`createMetadataWriteStream`](../../../mongoshield/src/classes/AbstractStorageProvider.md#createmetadatawritestream)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`emit`](../../../mongoshield/src/classes/AbstractStorageProvider.md#emit)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`eventNames`](../../../mongoshield/src/classes/AbstractStorageProvider.md#eventnames)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`finalize`](../../../mongoshield/src/classes/AbstractStorageProvider.md#finalize)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`getMaxListeners`](../../../mongoshield/src/classes/AbstractStorageProvider.md#getmaxlisteners)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`initialize`](../../../mongoshield/src/classes/AbstractStorageProvider.md#initialize)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`listenerCount`](../../../mongoshield/src/classes/AbstractStorageProvider.md#listenercount)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`listeners`](../../../mongoshield/src/classes/AbstractStorageProvider.md#listeners)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`off`](../../../mongoshield/src/classes/AbstractStorageProvider.md#off)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`on`](../../../mongoshield/src/classes/AbstractStorageProvider.md#on)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`once`](../../../mongoshield/src/classes/AbstractStorageProvider.md#once)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`prependListener`](../../../mongoshield/src/classes/AbstractStorageProvider.md#prependlistener)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`prependOnceListener`](../../../mongoshield/src/classes/AbstractStorageProvider.md#prependoncelistener)

***

### prune()

> **prune**(`policy`): `Promise`\<[`PruningResult`](../../../mongoshield/src/interfaces/PruningResult.md)\>
...
[`PruningPolicy`](../../../mongoshield/src/interfaces/PruningPolicy.md)

The pruning policy defining retention rules.

#### Returns

`Promise`\<[`PruningResult`](../../../mongoshield/src/interfaces/PruningResult.md)\>

#### Inherited from

[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`prune`](../../../mongoshield/src/classes/AbstractStorageProvider.md#prune)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`rawListeners`](../../../mongoshield/src/classes/AbstractStorageProvider.md#rawlisteners)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`removeAllListeners`](../../../mongoshield/src/classes/AbstractStorageProvider.md#removealllisteners)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`removeListener`](../../../mongoshield/src/classes/AbstractStorageProvider.md#removelistener)
...
[`AbstractStorageProvider`](../../../mongoshield/src/classes/AbstractStorageProvider.md).[`setMaxListeners`](../../../mongoshield/src/classes/AbstractStorageProvider.md#setmaxlisteners)
