...
[MongoShield Documentation](../../../modules.md) / [core/src](../README.md) / AbstractStorageProvider

# Abstract Class: AbstractStorageProvider

Defined in: packages/core/src/providers/AbstractStorageProvider.ts:12
...
Defined in: node\_modules/.pnpm/@types+node@25.3.5/node\_modules/@types/node/events.d.ts:90
