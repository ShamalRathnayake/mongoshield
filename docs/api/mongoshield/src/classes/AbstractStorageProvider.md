...
[MongoShield Documentation](../../../modules.md) / [mongoshield/src](../README.md) / AbstractStorageProvider

# Abstract Class: AbstractStorageProvider

Defined in: [packages/core/src/providers/AbstractStorageProvider.ts:16](https://github.com/ShamalRathnayake/mongoshield/blob/37c34f4f1cc9c7701b1a943dbf51b10313c93a11/packages/core/src/providers/AbstractStorageProvider.ts#L16)
...
- [`ArchiveProvider`](ArchiveProvider.md)
- [`FileSystemProvider`](../../../provider-local/src/classes/FileSystemProvider.md)
...
> **new AbstractStorageProvider**(`options?`): `AbstractStorageProvider`

Defined in: node\_modules/.pnpm/@types+node@25.6.0/node\_modules/@types/node/events.d.ts:54
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`createArchiveWriteStream`](../interfaces/StorageProvider.md#createarchivewritestream)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`createBsonWriteStream`](../interfaces/StorageProvider.md#createbsonwritestream)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`createMetadataWriteStream`](../interfaces/StorageProvider.md#createmetadatawritestream)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`finalize`](../interfaces/StorageProvider.md#finalize)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`initialize`](../interfaces/StorageProvider.md#initialize)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`on`](../interfaces/StorageProvider.md#on)
...
[`StorageProvider`](../interfaces/StorageProvider.md).[`prune`](../interfaces/StorageProvider.md#prune)
